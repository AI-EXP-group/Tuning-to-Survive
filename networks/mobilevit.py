...
def mobilevit_xxs():
    ...
    return MobileViT((64, 64), dims, channels, num_classes=200, expansion=2, patch_size=(2, 2))


def mobilevit_xs():
    dims = [96, 120, 144]
    channels = [16, 32, 48, 48, 64, 64, 80, 80, 96, 96, 384]
    return MobileViT((64, 64), dims, channels, num_classes=200, patch_size=(2, 2))
